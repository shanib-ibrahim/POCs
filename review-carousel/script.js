...
const username = document.getElementById("review-details__name");
const designation = document.getElementById("review-details__designation");
const reviewDes = document.getElementById("review-description");
...
leftButton.addEventListener("click", () => {
  ...
  reviewDes.innerText = review.review;
});
